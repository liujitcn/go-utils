...
// Close 关闭 ip2region 服务并使用默认超时时间等待资源回收。
func (ip2r *Ip2Region) Close() {
	ip2r.CloseTimeout(time.Second * 10)
}

// CloseTimeout 在指定超时时间内关闭 ip2region 服务。
