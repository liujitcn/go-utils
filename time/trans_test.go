...
func TestUnixMilliToStringPtr(t *testing.T) {
	...
	fmt.Println("START: ", StringToUnixMilliInt64Ptr("2023-03-09 00:00:00"))
	fmt.Println("END: ", StringToUnixMilliInt64Ptr("2023-03-09 23:59:59"))

	fmt.Println(StringTimeToTime("2023-03-01 00:00:00"))
	fmt.Println(*StringDateToTime(trans.String("2023-03-01")))

	fmt.Println(StringTimeToTime("2023-03-08 00:00:00").UnixMilli())
	fmt.Println(StringDateToTime(trans.String("2023-03-07")).UnixMilli())
}

func TestTimeToDateString(t *testing.T) {
	fmt.Println(TimeToTimeString(time.Now()))
	fmt.Println(TimeToDateString(time.Now()))
}
