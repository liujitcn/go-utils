...
func TestForEach(t *testing.T) {
	...
	ForEach(daysMap, func(_ string, day int) {
		sum += day
	})
...
func TestDrop(t *testing.T) {
	...
	assert.Equal(t, expectedResult, Drop(daysMap, []string{"Monday", "Tuesday", "Wednesday", "Thursday", "Saturday"}))
...
func TestFilter(t *testing.T) {
	...
	filteredDays := Filter(daysMap, func(_ string, value int) bool {
		return value%2 == 0
	})
